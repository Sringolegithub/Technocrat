                ...
                <div className="row-1">
                    <div className="column-1">
                        <div className="col-div-1">
                            <img src="/Assets/images/AboutImg/Meeting.png" />
                ...
                <div className="row-3">
                    ...
                    <div className="col-3">
                        ...
                        <div className="row-col-4">
                            <div className="imgs">
                                <img src="/Assets/images/AboutImg/Net of High Quality Prof.png" />
                            </div>
                            <div className="content">
                    ...
                    <div className="col-3">
                        ...
                        <div className="row-col-4">
                            <div className="imgs">
                                <img src="/Assets/images/AboutImg/Trusted by.png" />
                            </div>
                            <div className="content">
                    ...
                    <div className="col-3">
                        ...
                        <div className="row-col-4">
                            <div className="imgs">
                                <img src="/Assets/images/AboutImg/Scalingup RPO.png" />
                            </div>
                            <div className="content">
